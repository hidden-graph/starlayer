...
through StarLayerGraph (no starsparql translation pipeline involved at
all) and compares against the suite's own official expected results - the
"does starlayergraph itself correctly execute these queries" check, independent
of anything the downstream starsparql project's own translation adds
