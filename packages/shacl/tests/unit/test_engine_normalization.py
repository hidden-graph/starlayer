...
from starshacl.engine import normalize_graph_inputs, normalize_to_starlayergraph_graph


EX = Namespace("http://example.org/")


def test_normalize_returns_same_starlayergraph_graph() -> None:
    graph = StarLayerGraph()

    out = normalize_to_starlayergraph_graph(graph, name="data_graph")
